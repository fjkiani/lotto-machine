...
def main():
    ...
    try:
        ...
        logger.info("Saved initial analysis to initial_analysis.json")
        ...
        with open("updated_analysis.json", "w") as f:
            json.dump(updated_analysis, f, indent=2)
        logger.info("Saved updated analysis to updated_analysis.json")
        
        # Save learning points to file
        with open("learning_points.txt", "w") as f:
            for i, point in enumerate(learning_points, 1):
                f.write(f"{i}. {point}\n")
        logger.info("Saved learning points to learning_points.txt")
