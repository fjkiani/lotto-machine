...
class FREDClient:
    ...
    SERIES = {
        ...
        "PPI":           {"id": "PPIACO",    "name": "PPI (All Commodities)",          "units": "Index"},
        ...
        "RETAIL_SALES":  {"id": "RSAFS",     "name": "Retail Sales",                   "units": "Millions $"},
        "HOUSING":       {"id": "EXHOSLUSM495S", "name": "Existing Home Sales",        "units": "Millions"},
        "CLAIMS":        {"id": "ICSA",      "name": "Initial Jobless Claims",         "units": "Thousands"},
        "DURABLE":       {"id": "DGORDER",   "name": "Durable Goods Orders",           "units": "Millions $"},
