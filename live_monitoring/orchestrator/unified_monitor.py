...
class UnifiedAlphaMonitor:
    ...
    def _init_monitors(self):
        ...
        try:
            ...
            self.signal_generator = SignalGenerator(api_key=api_key, dp_client=self.dp_client)
    ...
    def _init_exploitation_modules(self):
        ...
        # Future: Opportunity Scanner (Phase 3)
            ...
            for symbol in self.symbols:
                ...
                if signal:
                    ...
                    embed = {
                        ...
                        "footer": {"text": f"Exploitation Phase 1 • Squeeze Detection"},
                        "timestamp": datetime.utcnow().isoformat()
                    }
